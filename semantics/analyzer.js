...
Constructor.prototype.analyze = function (context, breedId) {
    ...
    currentBreed.fields.forEach((field) => {
        if (this.parameters && !this.parameters.ids.includes(field.id) && field.variable.initializerExp === null) {
...
KennelLiteral.prototype.analyze = function (context) {
    ...
    this.keyValuePairs.length > 0 ? [this.keyValuePairs[0].key.type, this.keyValuePairs[0].value.type] : [null, null];
