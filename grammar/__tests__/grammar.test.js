...
const readmeExamples = [
  ...
  ['string declarations with exclamation points', 'bark string dogName is "CeCe!!!!!!!!!!!";', 'Declaration'],
  ['string concatenation', 'bark string dogName is "Ce" with "Ce";', 'Statement'],
  ['string interpolation', 'bark string sentence is "![x] is a good girl";', 'Statement'],
  ...
  ['list using without keyword', 'bark list dogNames[string] is ["CeCe", "Fluffy"] without "CeCe";', 'Declaration'],
  ...
  ['greater than or equal to comparators', 'x is at least y', 'EqualityExp'],
  ['less than or equal to comparators', 'x is at most y', 'EqualityExp'],
  ['addition', 'x + y', 'Term'],
  ...
  ['while loops',
   `loop while x is at most 5:
        say x;
    end`, 
   'Statement'],
  ['for loops',
   `loop number i is 0 by i*2 while i is less than 10:
        say i;
    end`, 
   'Statement'],
  ['for each loops', 
   `loop element through myList:
        say element;
    end`, 
   'Statement'],
  ['function declaration', 
   `bark func gcd chases[number:num1, number:num2] fetches number:
